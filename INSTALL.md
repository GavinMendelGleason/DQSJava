...
To make DQS work you need the latest DQS library for Cliopatria. To pull this execute the following command line instructions from the root of the repository:
